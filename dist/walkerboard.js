...
/***/ function(module, exports, __webpack_require__) {
	...
	var dashboard = new _libDashboardManager2["default"](boardUrl, { fetch: function fetch() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BoardError = __webpack_require__(253);
	...
	exports["default"] = _react2["default"].createClass({
	    ...
	    renderPanels: function renderPanels(board, panelData, refreshPanelData) {
	        return board.when({
	            ...
	            error: function error(err) {
	                return _react2["default"].createElement(_BoardError2["default"], { error: err });
	            },
...
/***/ function(module, exports, __webpack_require__) {
	...
	function load(manager) {
	    (0, _util.fetchJSONIfPossible)(manager.fetch, manager.url).then(function (result) {
	        ...
	        manager.boards = (0, _Maybe2["default"])(error);
	    }).then(function () {
	...
	function initialiseBoards(manager, obj) {
	    ...
	    return obj.Boards.map(function (board) {
	        return new _Dashboard2["default"](board, { fetch: manager.fetch, notify: function notify() {
	                return manager[$notify]();
	            } });
	    });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var invalidError = function invalidError(reason) {
	    return new Error("Invalid Board JSON (" + reason + ")");
	};
	...
	function validatePanelDefinition(panel, index) {
	    ["Update", "X", "Y", "W", "H"].forEach(function (prop) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _widgetsText = __webpack_require__(243);
	                        ...
	                        return _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                { href: "#", onClick: function (ev) {
	                                        console.log(ev);
	                                        _this2.props.onChangeBoard(data.index);
	                                    } },
	                                data.title
	                            )
	                        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defineProperty = __webpack_require__(249)["default"];
